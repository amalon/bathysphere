...
#define LINKTIME_ASSERT(COND, NAME)                                            \
    do {                                                                       \
      ...
      COMPILETIME_ASSERT(constexpr(COND), COND_should_be_const);               \
      if (!(COND))                                                             \
        NAME();                                                                \
    } while (0)
...
#define RUNTIME_ASSERT(COND, NAME, ARGS...)     do {} while (0)
...
#define RUNTIME_ASSERT(COND, NAME, ARGS...)                                    \
    do {                                                                       \
      if (unlikely(!(COND))) {                                                 \
