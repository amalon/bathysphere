...
namespace maths
{
      ...
      class Matrix
  {
    ...
    public:
      ...
      template <int NN>
      inline friend Matrix<NN,T> scaleMatrix(const maths::Vector<N,T> &v)
      {
      ...
      template <int NN>
      inline friend Matrix<NN,T> translationMatrix(const maths::Vector<N,T> &v)
      {
        return Matrix<NN,T>::translation(v);
      }
      ...
      template <int NN>
      inline friend Matrix<NN,T> rotationMatrix(const maths::Vector<N,T> &axis, T theta)
      {
        return Matrix<NN,T>::rotation(axis, theta);
      }
